...
<div class="container-fluid">
    ...
    <div class="card-block row w-100 m-0">
        @include('CmsCore::product.product.properties-spfs-tags._partials.property')
{{--        @include('CmsCore::product.product.properties-spfs-tags._partials.tag')--}}
        @include('CmsCore::product.product.properties-spfs-tags._partials.specification')
