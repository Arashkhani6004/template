...
@section('title') افزودن جلسه @stop
@section('content')
<div class="body d-flex py-3">
                ...
                <div class="border-0 mb-4">
                    <div
                        ...
                        <h3 class="fw-bolder mb-0">
                            افزودن جلسه برای دوره {{ $course->title }}
                        </h3>
                        @else
                        <h3 class="fw-bolder mb-0">
                            افزودن جلسه
    ...
    <div class="container-fluid">
        <div class="card border p-2">
            <form id="cms-form" action="{{url('admin/session/create')}}" method="POST" enctype="multipart/form-data">
                @csrf
