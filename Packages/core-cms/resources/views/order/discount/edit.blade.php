...
@section('title') ویرایش کد تخفیف @stop
@section('content')
<div class="body d-flex py-3">
    ...
    <div class="container-fluid">
        <div class="card border p-2">
            <form action="{{route('admin.discount.edit',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data"
                id="cms-form" @submit.prevent="validateForm">
                @csrf
                @include('CmsCore::order.discount.form')
            </form>
        </div>
    </div>
</div>
