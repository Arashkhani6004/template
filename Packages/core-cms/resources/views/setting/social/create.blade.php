...
@section('title') افزودن شبکه های اجتماعی @stop
@section('content')
<div class="body d-flex py-3">
    ...
    <div class="container-fluid">
        <div class="card border p-2">
            <form action="{{route('admin.social.create')}}" method="POST" enctype="multipart/form-data" id="cms-form"
                @submit.prevent="validateForm">
                @csrf
                @include('CmsCore::setting.social.form')
            </form>
        </div>
    </div>
</div>
