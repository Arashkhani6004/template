...
function jdate($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
 ...
 for($i=0; $i<$sl; $i++){
  ...
  switch($sub){
	...
	case'D':
	$out.=jdateCostum_words(array('kh'=>$date[7]),' ');
	break;

	case'f':
	$out.=jdateCostum_words(array('ff'=>$j_m),' ');
	break;

	case'F':
	$out.=jdateCostum_words(array('mm'=>$j_m),' ');
	break;
	...
	case'J':
	$out.=jdateCostum_words(array('rr'=>$j_d),' ');
	break;
	...
	case'l':
	$out.=jdateCostum_words(array('rh'=>$date[7]),' ');
	break;
	...
	case'M':
	$out.=jdateCostum_words(array('km'=>$j_m),' ');
	break;
	...
	case'p':
	$out.=jdateCostum_words(array('mb'=>$j_m),' ');
	break;
	...
	case'q':
	$out.=jdateCostum_words(array('sh'=>$j_y),' ');
	break;
	...
	case'r':
	$key=jdateCostum_words(array('rh'=>$date[7],'mm'=>$j_m));
	...
	case'v':
	 $out.=jdateCostum_words(array('ss'=>substr($j_y,2,2)),' ');
	break;

	case'V':
	$out.=jdateCostum_words(array('ss'=>$j_y),' ');
	break;
...
function jstrftime($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
 ...
 for($i=0; $i<$sl; $i++){
  ...
  switch($sub){
	...
	/* Day */
	case'a':
	$out.=jdateCostum_words(array('kh'=>$date[6]),' ');
	break;

	case'A':
	$out.=jdateCostum_words(array('rh'=>$date[6]),' ');
	break;
	...
	case'c':
	$key=jdateCostum_words(array('rh'=>$date[6],'mm'=>$j_m));
...
function jgetdate($timestamp='',$none='',$tz='Asia/Tehran',$tn='en'){
 ...
 $jdateCostum=explode('_',jdateCostum('F_G_i_j_l_n_s_w_Y_z',$ts,'',$tz,$tn));
 return array(
	'seconds'=>tr_num((int)tr_num($jdateCostum[6]),$tn),
	'minutes'=>tr_num((int)tr_num($jdateCostum[2]),$tn),
	'hours'=>$jdateCostum[1],
	'mday'=>$jdateCostum[3],
	'wday'=>$jdateCostum[7],
	'mon'=>$jdateCostum[5],
...
/*	F	*/
function jdateCostum_words($array,$mod=''){
