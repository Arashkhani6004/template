<div class="col-6 p-1 filter-mobile p-0 d-lg-none d-block">
    <button type="button"
            class="btn btn-one d-flex align-items-center w-100 py-1 px-4 btn-sm text-center justify-content-center rounded-3"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="filter ">
                        ...
                        @include('pages.brand-detail.components.filtered-item')
                        <div class="accordion accordion-flush mt-2" id="accordionFlushExampleMobile">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwoMobile" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body categories">
                                            @include('pages.brand-detail.components.brand')
                                        </div>
                                    </div>
                                </div>
                            @endif
                            <div class="accordion-item" v-for="filter in filters" :key="filter.id">
                                <p class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            :data-bs-target="'#flush-collapseFourMobile'+filter.id"
                                            aria-expanded="false" :aria-controls="'flush-collapseFourMobile'+filter.id">
                                        @{{ filter.title }}
                                    </button>
                                </p>
                                <div :id="'flush-collapseFourMobile'+filter.id" class="accordion-collapse collapse"
                                     data-bs-parent="#accordionFlushExampleMobile">
                                            ...
                                            <li class="list-unstyled m-0" v-for="child in searchedChildren(filter)"
                                                ...
                                                <div class="form-check" v-else>
                                                    ...
                                                    <label class="form-check-label small"
                                                           :for="'flexCheckDefaults'+child.id">@{{ child.title
                                                        }}</label>
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <div class="accordion-item">
                                <p class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseThreeMobile" aria-expanded="false"
                                            aria-controls="flush-collapseThreeMobile">
                                        دسته بندی
                                    </button>
                                </p>
                                <div id="flush-collapseThreeMobile" class="accordion-collapse collapse"
                                     data-bs-parent="#accordionFlushExampleMobile">
                                    <div class="accordion-body p-2">
                                        <div class="search position-relative mb-2">
                                            <input type="search" v-model="searchCategory"
                                                   class="form-control form-control-sm" placeholder="جستجوی نام دسته">
                                            <button type="button"
                                                    class="btn btn-search bg-transparent p-2 shadow-none border-0 position-absolute top-0 bottom-0 end-0">
                                                <i class="bi bi-search d-flex"></i>
                                            </button>
                                        ...
                                        <ul class="p-0 m-0 px-2">
                                            ...
                                            <li class="list-unstyled" v-for="(category,index) in searchedCategories">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" :value="category.id"
                                                           v-model="selectedCategories" :id="'flexCheckDefault'+index">
                                                    <label class="form-check-label small"
    ...
    <div class="modal fade" id="sortModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('pages.brand-detail.components.sort')
