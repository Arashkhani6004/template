        ...
        <div class="row w-100 m-0">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 p-xxl-2 p-xl-1 p-lg-2 p-sm-2 p-1 mb-sm-0 mb-4">
                <div class="package-card">
                    <a href="{{ route('blog.list', ['url' => $row['url']]) }}" class="color-title text-start h-rotate">
                        <img src="{{$row['item_image']}}" class="w-100 main-image" alt="{{$row['title']}}"
                            title=" {{$row['title']}}">
                        <div class="py-4 px-3">
                            <div class="row w-100 m-0">
                                <div class="col-lg-12 col-12 p-0 align-self-center">
                                    <div class="package-title">
                                        <p class="m-0 font-bold small">
                                         {{$row['title']}}
                                        </p>
                                    </div>
                                </div>
