    ...
    <section class="packages">
        <div class="px-xxl-5 px-xl-4 px-lg-3">
            <div class="package-inner">
                <div class="container">
                    <div
                        class="title-section mb-sm-5 mb-4 text-center col-xxl-5 col-xl-6 col-lg-7 col-md-12 m-auto p-0">
                        <p class="fw-bolder h2 mb-4 title">{!! @$settings['first_page_package_title'] !!}</p>
                        <p class="font-th op-lighter short-des">
                            {!! @$settings['first_page_package_text'] !!}
                        </p>
                    </div>
                    <div class="row w-100 m-0 pt-3">
                        <div class="col-xxl-8 col-xl-7 p-0 pe-xl-3 mb-xl-0 mb-4">
                            <div class="swiper swiper-package" dir="rtl">
                                                ...
                                                <a href="{{ route('package.detail', ['url' => $package['url']]) }}" class="color-title text-start h-rotate">
                                                    ...
                                                    <ul class="p-0 m-0 py-4">
                                                        @foreach($package['services'] as $package_service)
                                                            <li class="d-flex align-items-center  font-th">
                                                                <img src="{{asset('assets/site/images/check-success.svg')}}"
                                                                     class="me-2" width="20" height="20"
                                                                     alt="پکیج فیچر" title="پکیچ فیچر">
                                                                {{$package_service['title']}}
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    <hr>
                                                    <p class="d-flex m-0 align-items-center main-price font-num">
                                                        <span class="me-1">
                                                    ...
                                                    @if($package['price'] != 0)
                                                    <p class="d-flex m-0 align-items-center old-price font-num-r">
                                                        <del class="me-1 ">
                        ...
                        <div class="col-xxl-4 col-xl-5 p-0 ps-xl-3">
                            <div class="row w-100 m-0">
                                <div class="col-xl-12 col-lg-6 p-xl-0 p-md-2">
                                    <a href="tel:{{$settings['main_phone_number']}}" class="contact-us mb-4 h-rotate d-block">
                                        <div class="d-flex align-items-start justify-content-between contact-text">
                                            <div>
                                                {{--Review : متن های این قسمت پویا شود--}}
                                                <p class="font-re m-0 mb-2 color-title">
                                                   {{$settings['support_call_text']}}
                                                </p>
                                                <p class="font-re small color-title op-lighter">
                                                    {{$settings['support_call_hours']}}
                                                </p>
                                            </div>
                                            <img src="{{asset('assets/site/images/tel-3d.svg')}}" alt="tel-icon" title="tel-icon"
                                        ...
                                        <div class="row w-100 m-0 contact-num">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="font-th op-lighter mb-1 color-title">{{$settings['phones_first_page_text']}}</p>
                                                <div class="d-flex align-items-center flex-wrap justify-content-end "
                                                     dir="ltr">
                                                    @foreach($settings['phone_numbers'] as $phone)
                                                        <span href="tel:{{$phone}}" class="me-3 font-th color-title">
                                ...
                                <div class="col-xl-12 col-lg-6 p-xl-0 p-md-2">
                                    {{--Review : لزوما ممکنه تلگرام نباشه--}}
                                    <a href="{{@$settings['online_support_link']}}"
                                       class="support h-rotate d-block">
                                        <div class="d-flex align-items-start justify-content-between mb-lg-4 mb-2">
                                            <div>
                                                ...
                                                <p class="font-re small color-title op-lighter">
                                                    {{$settings['online_support_hours']}}
                                                </p>
                                            </div>
                                            {{--Review : این تصویر پویا شود و از تنظیمات گذاشته بشه--}}
                                            <img src="{{@$settings['online_support_image']}}" alt="tel-icon" title="tel-icon"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="font-th op-lighter mb-1 color-title"> {{$settings['online_support_title']}}</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
